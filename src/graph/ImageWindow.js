...
{
    if(!width || !height) {
        throw new Error("ImageWindow must receive a width and height during construction");
    }
...
parsegraph_ImageWindow.prototype.setOnScheduleUpdate = function(schedulerFunc, schedulerFuncThisArg)
{
...
parsegraph_ImageWindow.prototype.width = parsegraph_ImageWindow.prototype.getWidth;

parsegraph_ImageWindow.prototype.getHeight = function()
{
    return this._explicitHeight*this.upscale();
};
parsegraph_ImageWindow.prototype.height = parsegraph_ImageWindow.prototype.getHeight;
...
parsegraph_ImageWindow.prototype.loadImageFromTexture = function(gl, texture, width, height)
{
...
parsegraph_ImageWindow.prototype.render = function()
{
    ...
    this.loadImageFromTexture(gl, this._targetTexture, targetTextureWidth, targetTextureHeight);
