...
export default class TexturePainter
{
    ...
    constructor(window:parsegraph_Window, textureId:number, texWidth:number, texHeight:number) {
        this._gl = window.gl();
    ...
    drawWholeTexture(x:number, y:number, width:number, height:number, scale:number):void {
