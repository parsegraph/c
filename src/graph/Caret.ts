...
export default class Caret {
    ...
    spawn(inDirection:Direction|string, newType:Type|string, newAlignmentMode?:Alignment|string):Node {
    ...
    disconnect(inDirection?:Direction|string):Node {
        ...
        return this.node().parentNode().disconnectNode(reverseDirection(this.node().parentDirection()));
    }
    ...
    spawnMove(inDirection:Direction|string, newType:Type|string, newAlignmentMode?:Alignment|string):Node {
    ...
    align(inDirection:Direction|string, newAlignmentMode:Alignment|string):void {
    ...
    pull(given:Direction|string):void {
        ...
        if(this.node().isRoot() || this.node().parentDirection() === Direction.OUTWARD) {
        ...
        if(getDirectionAxis(given) === getDirectionAxis(this.node().parentDirection())) {
